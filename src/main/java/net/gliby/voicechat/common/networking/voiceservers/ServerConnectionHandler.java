    ...
    private void onConnected(final EntityPlayer entity) {
        ...
        if (voiceChat.getVoiceServer() instanceof VoiceAuthenticatedServer) {
            ...
            VoiceChat.getDispatcher()
                .sendTo(
                    new MinecraftClientVoiceAuthenticatedServer(
                        ...
                        voiceChat.getServerSettings()
                            .getUDPPort(),
                        hash,
                        voiceChat.serverSettings.isUsingProxy() ? voiceChat.serverNetwork.getAddress() : ""),
                    player);
        } else VoiceChat.getDispatcher()
            .sendTo(
                new MinecraftClientVoiceServerPacket(
                    voiceChat.getServerSettings()
                        .canShowVoicePlates(),
                    voiceChat.getServerSettings()
                        .canShowVoiceIcons(),
