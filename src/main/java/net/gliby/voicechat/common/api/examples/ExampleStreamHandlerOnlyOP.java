...
public class ExampleStreamHandlerOnlyOP {
    ...
    public ExampleStreamHandlerOnlyOP() {
        // Tells API to use this stream handler, because we don't want to use the original one. Otherwise audio will be
        // sent twice.
        // You don't have to do this if you want to modify or monitor events.
        VoiceChatAPI.instance()
            .setCustomStreamHandler(this);
    }
    ...
    public boolean isOP(EntityPlayerMP player) {
        return player.mcServer.getConfigurationManager()
            .func_152603_m()
            .func_152683_b(player.getGameProfile()) != null;
    }
