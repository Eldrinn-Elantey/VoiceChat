...
public class ClientNetwork {
    ...
    public void handleVoiceAuthenticatedServer(boolean showVoicePlates, boolean showVoiceIcons, int minQuality,
        int maxQuality, int bufferSize, int soundDistance, int voiceServerType, int udpPort, String hash, String ip) {
        this.startClientNetwork(
            EnumVoiceNetworkType.values()[voiceServerType],
            hash,
            ip,
            udpPort,
            soundDistance,
    ...
    public void handleVoiceServer(boolean canShowVoicePlates, boolean canShowVoiceIcons, int minQuality, int maxQuality,
        int bufferSize, int soundDistance, int voiceServerType) {
        this.startClientNetwork(
            EnumVoiceNetworkType.values()[voiceServerType],
            null,
            null,
    ...
    public VoiceClient startClientNetwork(EnumVoiceNetworkType type, String hash, String ip, int udpPort, int soundDist,
        int bufferSize, int soundQualityMin, int soundQualityMax, boolean showVoicePlates, boolean showVoiceIcons) {
        this.voiceChat.getSettings()
            .resetQuality();
        ...
        switch (type) {
            ...
            case UDP:
                ...
                if (serverAddress.isEmpty()) {
                    ...
                    if ((serverData = Minecraft.getMinecraft()
                        .func_147104_D()) != null) {
        ...
        voiceChat.getSettings()
            .setNetworkQuality(soundQualityMin, soundQualityMax);
        voiceChat.getSettings()
            .setSoundDistance(soundDist);
        voiceChat.getSettings()
            .setVoiceIconsAllowed(showVoiceIcons);
        voiceChat.getSettings()
            .setVoicePlatesAllowed(showVoicePlates);
        ...
        connected = true;
        VoiceChatClient.getLogger()
            .info(
                "Connecting to [" + type.name
