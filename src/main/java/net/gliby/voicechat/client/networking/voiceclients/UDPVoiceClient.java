...
public class UDPVoiceClient extends VoiceAuthenticatedClient {
    ...
    public void handleAuth() {
        VoiceChat.getLogger()
            .info("Successfully authenticated with voice server, client functionical.");
        this.setAuthed(true);
    }
    ...
    public void start() {
        ...
        VoiceChat.getLogger()
            .info("Connected to UDP[" + host + ":" + port + "] voice server, requesting authentication.");
        autheticate();
        while (running) {
