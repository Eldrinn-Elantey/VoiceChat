                ...
                public void run() {
                    if (event.entity instanceof EntityOtherPlayerMP) {
                        ...
                        if (!VoiceChatClient.getSoundManager().playersMuted.contains(player.getEntityId())) {
                            ...
                            for (final Map.Entry<Integer, String> entry : ClientStreamManager.playerMutedData
                                .entrySet()) {
                                ...
                                if (value.equals(player.getCommandSenderName())) {
                                    ...
                                    ClientStreamManager.playerMutedData
                                        .put(player.getEntityId(), player.getCommandSenderName());
                                    break;
                                }
                            }
                        }

                        final PlayerProxy proxy = VoiceChatClient.getSoundManager().playerData
