...
public class Settings {
    ...
    public Settings(File file) {
        ...
        uiPositionSpeak = new UIPosition(
            EnumUIPlacement.SPEAK,
            EnumUIPlacement.SPEAK.x,
            EnumUIPlacement.SPEAK.y,
            EnumUIPlacement.SPEAK.positionType,
            1.0f);
        uiPositionPlate = new UIPosition(
            EnumUIPlacement.VOICE_PLATES,
            EnumUIPlacement.VOICE_PLATES.x,
            EnumUIPlacement.VOICE_PLATES.y,
            EnumUIPlacement.VOICE_PLATES.positionType,
            1.0f);
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (newDefault.ID != getModPackID()) {
                        VoiceChat.getLogger()
                            .info("Modpack defaults applied, original settings overwritten.");
                        uiPositionSpeak = new UIPosition(
                            EnumUIPlacement.SPEAK,
                            newDefault.SPEAK_ICON.X,
                            newDefault.SPEAK_ICON.Y,
                            newDefault.SPEAK_ICON.TYPE,
                            newDefault.SPEAK_ICON.SCALE);
                        uiPositionPlate = new UIPosition(
                            EnumUIPlacement.VOICE_PLATES,
                            newDefault.VOICE_PLATE.X,
                            newDefault.VOICE_PLATE.Y,
                            newDefault.VOICE_PLATE.TYPE,
                            newDefault.VOICE_PLATE.SCALE);
